    ...
    return (
      <Layout nav={true}>
        <div className="mx-auto container max-w-screen-xl lg:my-16 my-8 px-4">
            ...
            <p className="font-light text-gray-500 sm:text-xl dark:text-gray-400">Randome thoughts.</p>
        </div> 
                ...
                return <div key={node.frontmatter.permalink} className="w-full flex flex-col md:flex-row bg-white border border-gray-200 rounded-sm shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="p-5 w-full md:w-3/5 lg:w-4/5">
                        ...
                        <div className="text-right">
                            <Button variant="outline" button={{url:node.frontmatter.permalink}} className="">Read more</Button>
                        </div>
                    </div>
                </div>
