              ...
              <div className='flex flex-col md:flex-row space-y-3 space-x-0 md:space-y-0 md:space-x-3 '>
                {nav?.show_contact_links && nav?.contact_links && (nav?.contact_links.map((link, i) => {
                  switch (link.platform) {
                    case "email":
                      return (
                        <a className='space-x-2 flex h-6 text-headerSocialTextDefaultColor hover:text-headerSocialTextHoverColor bg-headerSocialTextDefaultBG hover:bg-headerSocialTextHoverBG dark:bg-transparent dark:text-white dark:hover:text-gray-300' href={`mailto:`+link.permalink} key={`social-menue-social-text`+i}>
                    ...
                    case "phone":
                      return (
                        <a className='space-x-2 flex h-6 text-headerSocialTextDefaultColor hover:text-headerSocialTextHoverColor bg-headerSocialTextDefaultBG hover:bg-headerSocialTextHoverBG dark:bg-transparent dark:text-white dark:hover:text-gray-300' href={`tel:`+link.permalink} key={`social-menue-social-text`+i}>
                    ...
                    case "calendar":
                      return (
                        <a className='space-x-2 flex h-6 text-headerSocialTextDefaultColor hover:text-headerSocialTextHoverColor bg-headerSocialTextDefaultBG hover:bg-headerSocialTextHoverBG dark:bg-transparent dark:text-white dark:hover:text-gray-300' href={link.permalink} key={`social-menue-social-text`+i}>
              ...
              <div className='flex flex-row lg:flex-row-reverse'>
                {nav?.show_social_links && nav?.social_links && (nav?.social_links.map((link, i) => {
                    switch (link.platform) {
                      case "facebook":
                        return (
                          <a className='spce-y-2 lg:space-x-2 flex-0 h-6 sm:h-6 text-headerSocialTextDefaultColor hover:text-headerSocialTextHoverColor bg-headerSocialTextDefaultBG hover:bg-headerSocialTextHoverBG dark:bg-transparent dark:text-white dark:hover:text-gray-300' href={link.permalink} key={`social-menue-social-icons`+i}>
                      ...
                      case "twitter":
                        return (
                          <a className='spce-y-2 lg:space-x-2 flex h-6 text-headerSocialTextDefaultColor hover:text-headerSocialTextHoverColor bg-headerSocialTextDefaultBG hover:bg-headerSocialTextHoverBG dark:bg-transparent dark:text-white dark:hover:text-gray-300' href={link.permalink} key={`social-menue-social-icons`+i}>
                      ...
                      case "instagram":
                        return (
                          <a className='space-x-2 flex h-6 text-headerSocialTextDefaultColor hover:text-headerSocialTextHoverColor  bg-headerSocialTextDefaultBG hover:bg-headerSocialTextHoverBG dark:bg-transparent dark:text-white dark:hover:text-gray-300' href={link.permalink} key={`social-menue-social-icons`+i}>
        ...
        <nav className="bg-header-bg bg-headerBg text-headerTextDefaultColor border-gray-200 px-4 lg:px-6 py-0 dark:bg-gray-600 shadow">
            <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div className={clsx({
                    ...
                    <DarkmodeToggle className="hidden md:block dark:text-white hover:text-headerTextHoverColor dark:hover:text-headerTextHoverColor" />
                    </div>
                </div>
            </div>
        </nav>
